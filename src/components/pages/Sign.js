...
import logo from "../images/monkblr logo.jpg";
...
function Sign() {
  ...
  const submitHandler = () => {
    ...
    fetch("http://localhost:4001/api/create-user", {
      ...
      .then((resp) => resp.json())
      .then((data) => {
        alert("Welcome to monkblr Blog" + getFullName);
        console.log(data);
          navigate("/Sign");
      })
      .catch((err) => {
      ...
      <div className="signForm">
        <div>
          ...
          <small>
            ...
            Automattic/monkblr <br /> declares no affiliation, sponsorship, nor
